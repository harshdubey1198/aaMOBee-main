...
const ManufacturerModal = ({ isOpen,idToUse , toggle,manufacturerAdd, manufacturerToEdit, onManufacturerUpdated, setTriggerManufacurer }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...manufacturer,
        firmId: idToUse || manufacturer.firmId, 
      };
