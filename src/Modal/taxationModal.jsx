...
function TaxationModal({ isOpen, toggle, config,idToUse, userId, tax, onTaxCreatedOrUpdated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = tax 
          ...
          : { taxName, taxRates, firmId: idToUse }; 
      ...
      toast.error('Failed to save tax , Please Check new Name ');
    }
  };
