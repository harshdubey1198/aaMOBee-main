...
const CategoryManager = () => {
  ...
  useEffect(() => {
    if (role === "client_admin" && !selectedFirmId) return; // Don't call yet
    if (!idToUse) return; // No ID, no request
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Breadcrumbs title="Product & Inventory" breadcrumbItem="Product Categories" />
        <Container>
          <Row>
            <Col lg={12}>
              <Card>
