...
function PreRegister() {
  ...
  <>
    ...
    <div className="pricing-div" style={{ background: "linear-gradient(to right, #e0ecff, #fefcea)",padding:"50px 50px 10px 50px", margin:"80px 0 0 0 ", minHeight: "calc(100vh - 80px)", }}>
