...
const handleUpdateQuantity = async (orderId, updatedData) => {
  try {
    await updateProductionOrderQuantity(orderId, updatedData);
    setModalOpen(false);
    refetchOrders();
    setNewQuantity('');
    setNewNote('');
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Breadcrumbs title="Production/Manufacturing" breadcrumbItem="Production Orders" />

        <div className="d-flex flex-wrap justify-content-start gap-2 mb-3 align-items-center">
          <BackButton/>
              <input
                type="text"
                value={searchTerm}
