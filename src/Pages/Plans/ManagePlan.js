...
function ManagePlan() {
  ...
  const featureOptions = predefinedFeatures.map((f) => ({
    value: f,
    label: f,
  }));
  ...
  const moveFeature = (fromIndex, toIndex) => {
    if (toIndex < 0 || toIndex >= selectedPlan.features.length) return;
          ...
          <FormGroup>
            ...
            {/* <ul className="list-unstyled">
              {selectedPlan.features.map((feature, index) => (
                <li key={index} className="d-flex align-items-center mb-2 gap-2">
                  <Input
                    type="text"
                    value={capitalize(feature)}
                    onChange={(e) =>
                      setSelectedPlan((prev) => ({
                        ...prev,
                  ...
                  <div className="btn-group-vertical">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => moveFeature(index, index + 1)}
                      disabled={index === selectedPlan.features.length - 1}
                    >
                      ↓
                    </Button>
                  </div>
              ...
              <li>
                <Button color="success" size="sm" onClick={handleAddFeature}>
                  + Add Feature
                </Button>
              </li>
            </ul> */}
