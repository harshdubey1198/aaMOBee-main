...
blogCategoryController.createBlogCategory = async (req, res) => {
  try {
    const newBlogCategory = await BlogCategoryServices.createBlogCategory(
      req.params.id,
      req.body
    );
    return res
      .status(200)
      .json(
        createResult("Blog category created successfully", newBlogCategory)
      );
  } catch (error) {
...
blogCategoryController.getBlogCategories = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json(
        createResult("Blog categories fetched successfully", blogCategories)
      );
  } catch (error) {
...
blogCategoryController.getBlogCategoryById = async (req, res) => {
  try {
    const blogCategory = await BlogCategoryServices.getBlogCategoryById(
      req.params.id
    );
    return res
      .status(200)
      .json(createResult("Blog category fetched successfully", blogCategory));
  } catch (error) {
...
blogCategoryController.updateBlogCategory = async (req, res) => {
  try {
    const updatedBlogCategory = await BlogCategoryServices.updateBlogCategory(
      req.params.id,
      req.body
    );
    return res
      .status(200)
      .json(
        createResult("Blog category updated successfully", updatedBlogCategory)
      );
  } catch (error) {
...
blogCategoryController.deleteBlogCategory = async (req, res) => {
  try {
    const deletedBlogCategory = await BlogCategoryServices.deleteBlogCategory(
      req.params.id
    );
    return res
      .status(200)
      .json(
        createResult("Blog category deleted successfully", deletedBlogCategory)
      );
  } catch (error) {
