...
const { handleDuePaymentNotification } = require("./socket.services");
...
const triggerDuePaymentNotification = async () => {
  const io = getSocketInstance();
  await handleDuePaymentNotification(io);
};

module.exports = { sendNotification, getUserNotifications, markNotificationAsRead, triggerDuePaymentNotification,};
